...
ElementsOfSuccessHtml = (MarkupString)"<p><strong>Relational Trust and Collaborative Spirit</strong></p><p> Teachers develop strong relationships with students and colleagues that support professional learning, collaboration, mutual trust, and student success. </p> <p><strong>Culture of Inquiry and Innovation</strong></p><p> Teachers contribute to the culture of the school by modeling school values, helping to identify underlying problems, and taking positive action toward their solution. </p> <p><strong>Service to the School</strong></p><p> Teachers extend their influence beyond their classrooms by leading and contributing to school events, projects, and initiatives.</p>",
AnswerText = [
