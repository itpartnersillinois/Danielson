...
namespace Danielson.Data.Migrations
{
    ...
    [Migration("20240606180716_MinorTweaks")]
            ...
            modelBuilder.Entity("Danielson.Data.DataModels.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssignmentId = 0,
                            DateEvaluated = new DateTime(2024, 6, 6, 13, 7, 15, 953, DateTimeKind.Local).AddTicks(5672),
                            DateSubmitted = new DateTime(2024, 6, 6, 13, 7, 15, 953, DateTimeKind.Local).AddTicks(5678),
                            ...
                            IsActive = true,
                            IsMidterm = false,
                            LastUpdated = new DateTime(2024, 6, 6, 13, 7, 15, 953, DateTimeKind.Local).AddTicks(5685),
                            PlacementType = "",
                            Position = "",
                            ProgramId = 0,
                            SemesterDate = "",
            ...
            modelBuilder.Entity("Danielson.Data.DataModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = false,
                            LastUpdated = new DateTime(2024, 6, 6, 13, 7, 15, 953, DateTimeKind.Local).AddTicks(5520),
                            Role = 99,
                            StudentEvaluationId = 0,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            IsActive = false,
                            LastUpdated = new DateTime(2024, 6, 6, 13, 7, 15, 953, DateTimeKind.Local).AddTicks(5537),
                            Role = 1,
                            StudentEvaluationId = 0,
                            Username = "student"
                        },
                        new
                        {
                            ...
                            IsActive = false,
                            LastUpdated = new DateTime(2024, 6, 6, 13, 7, 15, 953, DateTimeKind.Local).AddTicks(5546),
                            Role = 2,
                            StudentEvaluationId = 0,
                            Username = "supervisor"
                        },
                        new
                        {
                            ...
                            IsActive = false,
                            LastUpdated = new DateTime(2024, 6, 6, 13, 7, 15, 953, DateTimeKind.Local).AddTicks(5555),
                            Role = 4,
                            StudentEvaluationId = 0,
                            Username = "cotestaff"
                        });
